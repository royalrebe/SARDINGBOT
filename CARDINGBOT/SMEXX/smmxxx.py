...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await smx.send_file(
            ...
            link_preview=False,
            buttons=[
                [Button.url("ᴅᴇᴘʟᴏʏ ʏᴏᴜʀ ᴏᴡɴ", "https://telegra.ph/file/60df1f8b311f05ac92725.mp4")],
